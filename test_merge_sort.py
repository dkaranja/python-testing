...
class MergeSortDivideConquerTest(TestCase, MergeSort):

    #   test an empty list
    def test_empty_list(self):
        test_case = []
        expected = []
        algo_result = self.divide_conquer(test_case)
...
class MergeSortMergeTest(TestCase, MergeSort):
    ...
    def test_two_empty_lists(self):
        ...
        expected = []
        algo_result = self.merge(test_list_one, test_list_two)
        self.assertEqual(expected, algo_result)
    ...
    def test_when_list_one_is_empty(self):
        ...
        expected = [7, 90]
        algo_result = self.merge(list_one, list_two)
        self.assertEqual(expected, algo_result)
